...
# 训练模型并保存每个epoch的损失
history_rnn = model_rnn.fit(X_train, y_train, epochs=20, batch_size=64, verbose=2)
history_lstm = model_lstm.fit(X_train, y_train, epochs=20, batch_size=64, verbose=2)
